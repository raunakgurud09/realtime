...
export const ProfileEditModal: React.FC<{
  ...
  const [attachedImage, setAttachedImage] = useState<File | null>();
  ...
  const handleUploadImage = async () => {
    ...
    formData.append("avatar", attachedImage);
              ...
              >
                ...
                <div className="flex flex-col justify-start items-center bg-zinc-900 w-full h-full">
                  <div className="relative flex items-center justify-center m-8 group group-hover:border-[1px] border-white hover:cursor-pointer">
                    {!attachedImage && (
                      <img
                        className="h-60 w-60 cursor-pointer rounded-full flex flex-shrink-0 object-contain bg-white"
                        src={user?.avatar.url}
                        alt="user"
                      />
                    )}
                    {attachedImage && (
                      <>
                        <img
                          className="h-60 w-60 cursor-pointer rounded-full flex flex-shrink-0 bg-white object-cover"
                    ...
                    <input
                      ...
                      placeholder="hi"
                      className="absolute flex flex-col item-center justify-center cursor-pointer w-full rounded-full z-40  h-full opacity-0"
                    />
                    <div
                  ...
                  {attachedImage && (
                    <div>
                      <button
                        ...
                        className="px-4 py-1 bg-green-600 rounded-lg"
                      >
                        Save
                      </button>
                    </div>
